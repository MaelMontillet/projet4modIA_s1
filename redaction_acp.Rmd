...
On analyse le jeu de donnée avec les gènes comme individus. On travaille donc avec 1615 individus et 36 variables.
...
On analyse le jeu de donnée avec les variables comme individus. On possède donc 1615 variables et 36 individus.
...
```{r}
ggplot(data_m, aes(x=kmeans.ind4, y=T3_6h)) + geom_boxplot()
```
